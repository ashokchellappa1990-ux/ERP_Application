...
const FLAGS = ["showGstin", "showCustomer", "showHsn", "showMrp", "showSavings", "showTaxBreakup", "showItemTax", "useBranchDetails", "showBranchName", "showContact", "showTransitPass", "showVehicleRent"] as const;
