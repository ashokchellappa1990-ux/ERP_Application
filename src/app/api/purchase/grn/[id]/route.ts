...
export async function GET(_req: Request, { params }: { params: { id: string } }) {
  ...
  const data: GrnDetail = {
      ...
      otherCharges: num(grn.otherCharges),
      transitPassRefNo: grn.transitPassRefNo ?? "", transitPassQty: grn.transitPassQty != null ? num(grn.transitPassQty) : "", transitPassRate: grn.transitPassRate != null ? num(grn.transitPassRate) : null, transitPassAmount: num(grn.transitPassAmount),
      roundOff: num(grn.roundOff), totalInvoiceValue: num(grn.totalInvoiceValue),
