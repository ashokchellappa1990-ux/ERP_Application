    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Vehicle-Driver Assignment", href: "/masters/transport/vehicle-assignment", icon: Link2 },
          ...
          { label: "Fuel Management", href: "/masters/transport/fuel-management", icon: Fuel },
          {
            ...
            icon: CircleDot,
            children: [
              { label: "Tyre Master & Stock", href: "/transport/tyre", icon: CircleDot },
              { label: "Tyre Fitting & Movement", href: "/transport/tyre/movement", icon: CircleDot },
              { label: "Tyre Inspection & Service", href: "/transport/tyre/service", icon: CircleDot },
              { label: "Tyre History", href: "/transport/tyre/history", icon: History },
              { label: "Tyre Reports & Analytics", href: "/transport/tyre/reports", icon: FileBarChart },
            ],
          },
