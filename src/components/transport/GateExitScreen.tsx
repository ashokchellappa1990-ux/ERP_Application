...
export function GateExitScreen() {
  ...
  return (
    <div className="space-y-6">
      ...
      {exitTarget && (
        <GateExitModal
          row={{ id: exitTarget.id, gateEntryNo: exitTarget.gateEntryNo, vehicleId: 0, vehicleNo: exitTarget.vehicleNo, driverId: null, driverName: null, transportCompanyId: null, transportCompanyName: null, dispatchPlanningId: null, dispatchExecutionId: null, dispatchType: null, referenceNo: null, customerName: null, arrivalTime: null, securityOfficer: null, remarks: null, status: "Completed", createdAt: "", loadingProgress: null, loadDispatchId: null, loadDispatchStatus: null, dispatchDate: null, totalQty: null, totalValue: null, invoiceNo: null, paymentStatus: null, productName: null, preLoadWeight: null, postLoadWeight: null, netWeight: null, saleType: null, saleOutstanding: null, entryType: "Dispatch", supplierId: null, supplierName: null, supplierGstin: null, expectedMaterial: null, grossWeight: null, grnId: null, grnStatus: null, tareWeight: null, grnNetWeight: null, grnTotalValue: null, invoiceRecorded: null, piInvoiceNo: null, piInvoiceDate: null, piPoNo: null, piDocRefNo: null, weightSlipRefNo: null }}
